suggestions={
    ...
    'MaeOC':{
        ...
        'cards':[
            ...
            'Yune, Goddess of Freedom and Chaos',
    ...
    'Maria':{
        ...
        'tips':[
            'In the right deck, this card has one of the best statlines in the game.',
    ...
    'Frederick':{
        ...
        'tips':[
            'Decks that class change cards early can deploy this card early.',
            'Decks with frequent class changes can find a lot of use out of this card.',
    ...
    'Robin5':{
        ...
        'tips':[
            'You should always run a 1 cost Robin(Female) alongside this card.',
            'You will always get positive value out of Skill 1.'
        ],
        'cards':[
    ...
    'Nowi':{
        ...
        'tips':[
            ...
            'Skill 1 is mandatory, so never deploy this card if you\'re low on bonds'
        ],
        'cards':[
            'Genny, Supreme Saint',
    ...
    'Jill':{
        ...
        'tips':[
            'It is recommended that you play a 1 cost Jill alongside this card.',
    ...
    'Elincia':{
        ...
        'tips':[
            ...
            'Ping @dreidel_mts for more info'
        ],
        'cards':[
    ...
    'Ike':{
        ...
        'tips':[
            ...
            'This card functions as a decent finisher.'
        ],
        'cards':[
    ...
    'Soren':{
        ...
        'tips':[
            ...
            'This card benefits from an aggressive playstyle that forces your opponent to take their orbs.',
            'You should generally run additional copies of Soren alongside this card.'
        ],
        'cards':[
    ...
    'Leif':{
        ...
        'tips':[
            ...
            'This card interacts well with Yellow\'s other Bond Skills. You don\'t even need to run many Yellow cards.'
        ],
        'cards':[
    ...
    'Seliph':{
        ...
        'tips':[
            'Skill 2 has the potential to generate the best value in the game with enough bonds.',
            'Combo with certain skills to unflip your bonds. You don\'t necessarily need other Yellow cards for this.',
    ...
    'Julia':{
        ...
        'tips':[
            ...
            'Skill 1 lets you place some of your bonds back into the deck to be drawn or milled again later.'
        ],
        'cards':[
            'Seliph, Savior of Light',
            'Nanna, Brave Princess',
    ...
    'Sigurd':{
        ...
        'tips':[
            ...
            'You should always play 0 cost Sigurd alongside this card.'
            'Ping Brainiac327 for more info'
        ],
        'cards':[
            'Seliph, Savior of Light',
            'Larcei, Gods-Matching Astra',
    ...
    'Canas':{
        ...
        'tips':[
            'The use of magic emblems allows this card to add any Tome card in the game to your hand. This has applications outside of Purple.',
    ...
    'Eliwood':{
        ...
        'tips':[
            ...
            'Never forget that his Support Skill can be used more than once.',
    ...
    'Ryoma':{
        ...
        'tips':[
            'This card benefits immensely from an aggressive playstyle.',
            'Deploying low cost white units and having them stick around will make this card more impactful.',
            'Slower, more top-heavy decks in white and black also benefit from being able to deploy big units at a low cost.'
        ],
        'cards':[
            'Kaze, Faithful Verdancy',
            'Hinoka, Heavenly Queen of the Shining Sun',
    ...
    'Hinoka':{
        ...
        'tips':[
            'This card is commonly run in flier decks.',
            'The movement options that this card provides can be incredibly impactful.',
    ...
    'Kaze':{
        ...
        'tips':[
            ...
            'White has 3 different cards with attack emblem and a 20 base support(effectively 40 support during your turn). Use them well.'
    ...
    'Flayn':{
        ...
        'tips':[
            ...
            'Combining this card with other tank-up CPs can make most Brown MCs deceptively tanky.'
        ],
        'cards':[
            'Sothis, The Beginning',
            'Byleth(Male), He Who Bears the Flames Within',
